      ...
      <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center space-y-4 text-center lg:text-left">
          <div className="space-y-4">
            ...
            <h1 className={`text-4xl font-bold -mt-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
        ...
        <div className={`w-full rounded-lg shadow-md p-6 border-1 ${
          isDarkMode 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className={`w-full h-[1px] my-6 ${isDarkMode ? 'bg-slate-700' : 'bg-gray-300'}`}></div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-2">
                <button
                  ...
                  className={`w-full border font-bold py-2 rounded-md transition-colors flex items-center justify-center gap-2 cursor-pointer ${
                    isDarkMode
            ...
            <div className={`p-4 rounded-lg ${isDarkMode ? 'bg-slate-700' : 'bg-gray-100'}`}>
              <h4 className={`font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-black'}`}>
                Tipos de Acesso:
              </h4>
              <ul className={`text-sm space-y-1 ${isDarkMode ? 'text-gray-300' : 'text-black'}`}>
